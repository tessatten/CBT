...
AAF1_beta_CDR3 <- AAF1_beta_dcr_cdr3_freq
AAF1_beta_CDR3$Month <- "1"
AAF1_beta_CDR3$Chain <- "beta"

AAF2_beta_CDR3 <- AAF2_beta_dcr_cdr3_freq
AAF2_beta_CDR3$Month <- "2"
AAF2_beta_CDR3$Chain <- "beta"

AAF3_beta_CDR3 <- AAF3_beta_dcr_cdr3_freq
AAF3_beta_CDR3$Month <- "3"
AAF3_beta_CDR3$Chain <- "beta"

AAF6_beta_CDR3 <- AAF6_beta_dcr_cdr3_freq
AAF6_beta_CDR3$Month <- "6"
AAF6_beta_CDR3$Chain <- "beta"

AAF12_beta_CDR3 <- AAF12_beta_dcr_cdr3_freq
AAF12_beta_CDR3$Month <- "12"
AAF12_beta_CDR3$Chain <- "beta"


#not sure about this
#will try to join data frames
AAF_beta <- rbind(AAF1_beta_CDR3, AAF2_beta_CDR3, AAF3_beta_CDR3, AAF6_beta_CDR3, AAF12_beta_CDR3)
AAF_beta$ID <- "AAF"
AAF_beta$`CDR3 AA sequence` <- as.character(AAF_beta$`CDR3 AA sequence`)
AAF_beta$Month <- as.numeric(AAF_beta$Month)
names(AAF_beta)[names(AAF_beta) == "CDR3 AA sequence"] <- "CDR3s"
names(AAF_beta)[names(AAF_beta) == "Number found in sample"] <- "Count"
dat=AAF_beta
...
scale_alpha_manual(values=c(0, 1)) +
          ...
          labs(title = 'Shared Clonotypes: Patient A (beta chain)', x = 'Month', y = 'Cumulative % of Sample')+
...
ggsave("A_beta_betical.pdf", width = 40, height = 47, units = c('cm'))
