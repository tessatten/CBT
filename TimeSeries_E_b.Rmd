...
AmAuF1_beta_CDR3 <- AmAuF1_beta_dcr_cdr3_freq
AmAuF1_beta_CDR3$Month <- "1"
AmAuF1_beta_CDR3$Chain <- "beta"

AmAuF3_beta_CDR3 <- AmAuF3_beta_dcr_cdr3_freq
AmAuF3_beta_CDR3$Month <- "3"
AmAuF3_beta_CDR3$Chain <- "beta"

AmAuF2_beta_CDR3 <- AmAuF2_beta_dcr_cdr3_freq
AmAuF2_beta_CDR3$Month <- "2"
AmAuF2_beta_CDR3$Chain <- "beta"


#not sure about this
#will try to join data frames
AmAuF_beta <- rbind(AmAuF1_beta_CDR3, AmAuF3_beta_CDR3, AmAuF2_beta_CDR3)
AmAuF_beta$ID <- "AmAuF"
AmAuF_beta$`CDR3 AA sequence` <- as.character(AmAuF_beta$`CDR3 AA sequence`)
AmAuF_beta$Month <- as.numeric(AmAuF_beta$Month)
names(AmAuF_beta)[names(AmAuF_beta) == "CDR3 AA sequence"] <- "CDR3s"
names(AmAuF_beta)[names(AmAuF_beta) == "Number found in sample"] <- "Count"
dat=AmAuF_beta
...
scale_alpha_manual(values=c(0, 1)) +
          ...
          labs(title = 'Shared Clonotypes: Patient E (beta chain)', x = 'Month', y = 'Cumulative % of Sample')+
...
ggsave("E_beta_betical.pdf", width = 40, height = 47, units = c('cm'))
