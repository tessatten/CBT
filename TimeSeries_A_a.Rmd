...
---
#here i am going to look by patient at shared clonotypes, if i can - for AAF.
---
...
AAF1_alpha_CDR3 <- AAF1_alpha_dcr_cdr3_freq
AAF1_alpha_CDR3$Month <- "1"
AAF1_alpha_CDR3$Chain <- "alpha"

AAF2_alpha_CDR3 <- AAF2_alpha_dcr_cdr3_freq
AAF2_alpha_CDR3$Month <- "2"
AAF2_alpha_CDR3$Chain <- "alpha"

AAF3_alpha_CDR3 <- AAF3_alpha_dcr_cdr3_freq
AAF3_alpha_CDR3$Month <- "3"
AAF3_alpha_CDR3$Chain <- "alpha"

AAF6_alpha_CDR3 <- AAF6_alpha_dcr_cdr3_freq
AAF6_alpha_CDR3$Month <- "6"
AAF6_alpha_CDR3$Chain <- "alpha"

AAF12_alpha_CDR3 <- AAF12_alpha_dcr_cdr3_freq
AAF12_alpha_CDR3$Month <- "12"
AAF12_alpha_CDR3$Chain <- "alpha"


#not sure about this
#will try to join data frames
AAF_alpha <- rbind(AAF1_alpha_CDR3, AAF2_alpha_CDR3, AAF3_alpha_CDR3, AAF6_alpha_CDR3, AAF12_alpha_CDR3)
AAF_alpha$ID <- "AAF"
AAF_alpha$`CDR3 AA sequence` <- as.character(AAF_alpha$`CDR3 AA sequence`)
AAF_alpha$Month <- as.numeric(AAF_alpha$Month)
names(AAF_alpha)[names(AAF_alpha) == "CDR3 AA sequence"] <- "CDR3s"
names(AAF_alpha)[names(AAF_alpha) == "Number found in sample"] <- "Count"
dat=AAF_alpha
...
sampleName1 <- paste("A", unique(temp1.mod$Month), unique(temp1.mod$Chain), sep = '-') #makes the sample name
sampleName2 <- paste("A", unique(temp2.mod$Month), unique(temp2.mod$Chain), sep = '-')
sampleName3 <- paste("A", unique(temp3.mod$Month), unique(temp3.mod$Chain), sep = '-') #makes the sample name
sampleName4 <- paste("A", unique(temp4.mod$Month), unique(temp4.mod$Chain), sep = '-')
sampleName5 <- paste("A", unique(temp5.mod$Month), unique(temp5.mod$Chain), sep = '-')
...
scale_alpha_manual(values=c(0, 1)) +
          ...
          scale_x_continuous(breaks = c(1, 3, 5, 7, 9), labels = c(12, 6, 3, 2, 1))+
          ...
          labs(title = 'Shared Clonotypes: Patient A (alpha chain)', x = 'Month', y = 'Cumulative % of Sample')+
...
ggsave("A_alpha_betical.pdf", width = 40, height = 47, units = c('cm'))
