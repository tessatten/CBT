...
AmAlF_beta <- rbind(AmAlF1_beta_CDR3, AmAlF3_beta_CDR3, AmAlF6_ALL_beta_CDR3, AmAlF8_ALL_beta_CDR3)
AmAlF_beta$ID <- "AmAlF"
AmAlF_beta$`CDR3 AA sequence` <- as.character(AmAlF_beta$`CDR3 AA sequence`)
AmAlF_beta$Month <- as.numeric(AmAlF_beta$Month)
names(AmAlF_beta)[names(AmAlF_beta) == "CDR3 AA sequence"] <- "CDR3s"
names(AmAlF_beta)[names(AmAlF_beta) == "Number found in sample"] <- "Count"
dat=AmAlF_beta
...
scale_alpha_manual(values=c(0, 1)) +
          ...
          labs(title = 'Shared Clonotypes: Patient D (beta chain)', x = 'Month', y = 'Cumulative % of Sample')+
...
ggsave("D_beta_betical.pdf", width = 40, height = 47, units = c('cm'))
