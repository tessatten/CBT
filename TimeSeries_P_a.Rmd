...
ZRM_alpha <- rbind(ZRM1_alpha_CDR3, ZRM2_alpha_CDR3, ZRM3_alpha_CDR3, ZRM6_alpha_CDR3, ZRM12_alpha_CDR3, ZRM17_alpha_CDR3, ZRM30_alpha_CDR3)
ZRM_alpha$ID <- "ZRM"
...
P_alpha <- rbind(ZRM1_alpha_CDR3, ZRM2_alpha_CDR3, ZRM3_alpha_CDR3, ZRM6_alpha_CDR3, ZRM17_alpha_CDR3, ZRM30_alpha_CDR3)
P_alpha$ID <- "ZRM"
P_alpha$`CDR3 AA sequence` <- as.character(P_alpha$`CDR3 AA sequence`)
P_alpha$Month <- as.numeric(P_alpha$Month)
names(P_alpha)[names(P_alpha) == "CDR3 AA sequence"] <- "CDR3s"
names(P_alpha)[names(P_alpha) == "Number found in sample"] <- "Count"
...
scale_alpha_manual(values=c(0, 1)) +
          ...
          scale_x_continuous(breaks = c(1, 3, 5, 7, 9, 11), labels = c(30, 17, 6, 3, 2, 1))+
...
annotate(geom = "segment", x = -Inf, xend = -Inf, y = -Inf, yend = Inf) +
          ...
          labs(title = 'Shared Clonotypes: Patient P (alpha chain)', x = 'Month', y = 'Cumulative % of Sample')+
