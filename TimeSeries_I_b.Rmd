...
LKM2_beta_CDR3 <- LKM2_beta_dcr_cdr3_freq
LKM2_beta_CDR3$Month <- "2"
LKM2_beta_CDR3$Chain <- "beta"

LKM4_beta_CDR3 <- LKM4_beta_dcr_cdr3_freq
LKM4_beta_CDR3$Month <- "4"
LKM4_beta_CDR3$Chain <- "beta"

LKM6_beta_CDR3 <- LKM6_beta_dcr_cdr3_freq
LKM6_beta_CDR3$Month <- "6"
LKM6_beta_CDR3$Chain <- "beta"

LKM12_beta_CDR3 <- LKM12_beta_dcr_cdr3_freq
LKM12_beta_CDR3$Month <- "12"
LKM12_beta_CDR3$Chain <- "beta"


#not sure about this
#will try to join data frames
LKM_beta <- rbind(LKM2_beta_CDR3, LKM4_beta_CDR3, LKM6_beta_CDR3, LKM12_beta_CDR3)
LKM_beta$ID <- "LKM"
LKM_beta$`CDR3 AA sequence` <- as.character(LKM_beta$`CDR3 AA sequence`)
LKM_beta$Month <- as.numeric(LKM_beta$Month)
names(LKM_beta)[names(LKM_beta) == "CDR3 AA sequence"] <- "CDR3s"
names(LKM_beta)[names(LKM_beta) == "Number found in sample"] <- "Count"
dat=LKM_beta
...
scale_alpha_manual(values=c(0, 1)) +
          ...
          labs(title = 'Shared Clonotypes: Patient I (beta chain)', x = 'Month', y = 'Cumulative % of Sample')+
...
ggsave("I_beta_betical.pdf", width = 40, height = 47, units = c('cm'))
