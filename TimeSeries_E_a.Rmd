...
---
#here i am going to look by patient at shared clonotypes, if i can - for AmAuF.
---
...
AmAuF1_alpha_CDR3 <- AmAuF1_alpha_dcr_cdr3_freq
AmAuF1_alpha_CDR3$Month <- "1"
AmAuF1_alpha_CDR3$Chain <- "alpha"

AmAuF3_alpha_CDR3 <- AmAuF3_alpha_dcr_cdr3_freq
AmAuF3_alpha_CDR3$Month <- "3"
AmAuF3_alpha_CDR3$Chain <- "alpha"

AmAuF2_alpha_CDR3 <- AmAuF2_alpha_dcr_cdr3_freq
AmAuF2_alpha_CDR3$Month <- "2"
AmAuF2_alpha_CDR3$Chain <- "alpha"


#not sure about this
#will try to join data frames
AmAuF_alpha <- rbind(AmAuF1_alpha_CDR3, AmAuF3_alpha_CDR3, AmAuF2_alpha_CDR3)
AmAuF_alpha$ID <- "AmAuF"
AmAuF_alpha$`CDR3 AA sequence` <- as.character(AmAuF_alpha$`CDR3 AA sequence`)
AmAuF_alpha$Month <- as.numeric(AmAuF_alpha$Month)
names(AmAuF_alpha)[names(AmAuF_alpha) == "CDR3 AA sequence"] <- "CDR3s"
names(AmAuF_alpha)[names(AmAuF_alpha) == "Number found in sample"] <- "Count"
dat=AmAuF_alpha
...
sampleName1 <- paste("E", unique(temp1.mod$Month), unique(temp1.mod$Chain), sep = '-') #makes the sample name
sampleName2 <- paste("E", unique(temp2.mod$Month), unique(temp2.mod$Chain), sep = '-')
sampleName3 <- paste("E", unique(temp3.mod$Month), unique(temp3.mod$Chain), sep = '-') #makes the sample name
...
scale_alpha_manual(values=c(0, 1)) +
          ...
          labs(title = 'Shared Clonotypes: Patient E (alpha chain)', x = 'Month', y = 'Cumulative % of Sample')+
...
ggsave("E_alpha_betical.pdf", width = 40, height = 47, units = c('cm'))
