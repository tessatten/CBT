...
---
#here i am going to look by patient at shared clonotypes, if i can - for ANF.
---
...
ANF1_alpha_CDR3 <- ANF1_alpha_dcr_cdr3_freq
ANF1_alpha_CDR3$Month <- "1"
ANF1_alpha_CDR3$Chain <- "alpha"

ANF3_alpha_CDR3 <- ANF3_alpha_dcr_cdr3_freq
ANF3_alpha_CDR3$Month <- "3"
ANF3_alpha_CDR3$Chain <- "alpha"

ANF6_alpha_CDR3 <- ANF6_alpha_dcr_cdr3_freq
ANF6_alpha_CDR3$Month <- "6"
ANF6_alpha_CDR3$Chain <- "alpha"

ANF19_alpha_CDR3 <- ANF19_alpha_dcr_cdr3_freq
ANF19_alpha_CDR3$Month <- "19"
ANF19_alpha_CDR3$Chain <- "alpha"


#not sure about this
#will try to join data frames
ANF_alpha <- rbind(ANF1_alpha_CDR3, ANF3_alpha_CDR3, ANF6_alpha_CDR3, ANF19_alpha_CDR3)
ANF_alpha$ID <- "ANF"
ANF_alpha$`CDR3 AA sequence` <- as.character(ANF_alpha$`CDR3 AA sequence`)
ANF_alpha$Month <- as.numeric(ANF_alpha$Month)
names(ANF_alpha)[names(ANF_alpha) == "CDR3 AA sequence"] <- "CDR3s"
names(ANF_alpha)[names(ANF_alpha) == "Number found in sample"] <- "Count"
dat=ANF_alpha
...
temp2 <- datWithFillseq[datWithFillseq$Month == "3",] #t2 second time point
temp3 <- datWithFillseq[datWithFillseq$Month == "6",] #third time point
temp4 <- datWithFillseq[datWithFillseq$Month == "19",] #fourth time point
...
sampleName1 <- paste("F", unique(temp1.mod$Month), unique(temp1.mod$Chain), sep = '-') #makes the sample name
sampleName2 <- paste("F", unique(temp2.mod$Month), unique(temp2.mod$Chain), sep = '-')
sampleName3 <- paste("F", unique(temp3.mod$Month), unique(temp3.mod$Chain), sep = '-') #makes the sample name
sampleName4 <- paste("F", unique(temp4.mod$Month), unique(temp4.mod$Chain), sep = '-')
...
scale_alpha_manual(values=c(0, 1)) +
          ...
          scale_x_continuous(breaks = c(1, 3, 5, 7), labels = c(19, 6, 3, 1))+
          ...
          labs(title = 'Shared Clonotypes: Patient F (alpha chain)', x = 'Month', y = 'Cumulative % of Sample')+
...
ggsave("F_alpha_betical.pdf", width = 40, height = 47, units = c('cm'))
