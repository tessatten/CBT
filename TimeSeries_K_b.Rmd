...
RBM1_beta_CDR3 <- RBM1_beta_dcr_cdr3_freq
RBM1_beta_CDR3$Month <- "1"
RBM1_beta_CDR3$Chain <- "beta"

RBM3_beta_CDR3 <- RBM3_beta_dcr_cdr3_freq
RBM3_beta_CDR3$Month <- "3"
RBM3_beta_CDR3$Chain <- "beta"

RBM2_beta_CDR3 <- RBM2_beta_dcr_cdr3_freq
RBM2_beta_CDR3$Month <- "2"
RBM2_beta_CDR3$Chain <- "beta"


#not sure about this
#will try to join data frames
RBM_beta <- rbind(RBM1_beta_CDR3, RBM3_beta_CDR3, RBM2_beta_CDR3)
RBM_beta$ID <- "RBM"
RBM_beta$`CDR3 AA sequence` <- as.character(RBM_beta$`CDR3 AA sequence`)
RBM_beta$Month <- as.numeric(RBM_beta$Month)
names(RBM_beta)[names(RBM_beta) == "CDR3 AA sequence"] <- "CDR3s"
names(RBM_beta)[names(RBM_beta) == "Number found in sample"] <- "Count"
dat=RBM_beta
...
scale_alpha_manual(values=c(0, 1)) +
          ...
          labs(title = 'Shared Clonotypes: Patient K (beta chain)', x = 'Month', y = 'Cumulative % of Sample')+
...
ggsave("K_beta_betical.pdf", width = 40, height = 47, units = c('cm'))
