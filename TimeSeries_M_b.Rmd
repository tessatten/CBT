...
RYF1_beta_CDR3 <- RYF1_beta_dcr_cdr3_freq
RYF1_beta_CDR3$Month <- "1"
RYF1_beta_CDR3$Chain <- "beta"

RYF2_beta_CDR3 <- RYF2_beta_dcr_cdr3_freq
RYF2_beta_CDR3$Month <- "2"
RYF2_beta_CDR3$Chain <- "beta"

RYF6_beta_CDR3 <- RYF6_beta_dcr_cdr3_freq
RYF6_beta_CDR3$Month <- "6"
RYF6_beta_CDR3$Chain <- "beta"

RYF8_beta_CDR3 <- RYF8_beta_dcr_cdr3_freq
RYF8_beta_CDR3$Month <- "8"
RYF8_beta_CDR3$Chain <- "beta"

RYF12_beta_CDR3 <- RYF12_beta_dcr_cdr3_freq
RYF12_beta_CDR3$Month <- "12"
RYF12_beta_CDR3$Chain <- "beta"

RYF22_beta_CDR3 <- RYF22_beta_dcr_cdr3_freq
RYF22_beta_CDR3$Month <- "22"
RYF22_beta_CDR3$Chain <- "beta"


#not sure about this
#will try to join data frames
RYF_beta <- rbind(RYF1_beta_CDR3, RYF2_beta_CDR3, RYF6_beta_CDR3, RYF8_beta_CDR3, RYF12_beta_CDR3, RYF22_beta_CDR3)
RYF_beta$ID <- "RYF"
RYF_beta$`CDR3 AA sequence` <- as.character(RYF_beta$`CDR3 AA sequence`)
RYF_beta$Month <- as.numeric(RYF_beta$Month)
names(RYF_beta)[names(RYF_beta) == "CDR3 AA sequence"] <- "CDR3s"
names(RYF_beta)[names(RYF_beta) == "Number found in sample"] <- "Count"
dat=RYF_beta
...
scale_alpha_manual(values=c(0, 1)) +
          ...
          labs(title = 'Shared Clonotypes: Patient M (beta chain)', x = 'Month', y = 'Cumulative % of Sample')+
...
ggsave("M_beta_betical.pdf", width = 40, height = 47, units = c('cm'))
