...
ANF1_beta_CDR3 <- ANF1_beta_dcr_cdr3_freq
ANF1_beta_CDR3$Month <- "1"
ANF1_beta_CDR3$Chain <- "beta"

ANF3_beta_CDR3 <- ANF3_beta_dcr_cdr3_freq
ANF3_beta_CDR3$Month <- "3"
ANF3_beta_CDR3$Chain <- "beta"

ANF6_beta_CDR3 <- ANF6_beta_dcr_cdr3_freq
ANF6_beta_CDR3$Month <- "6"
ANF6_beta_CDR3$Chain <- "beta"

ANF19_beta_CDR3 <- ANF19_beta_dcr_cdr3_freq
ANF19_beta_CDR3$Month <- "19"
ANF19_beta_CDR3$Chain <- "beta"


#not sure about this
#will try to join data frames
ANF_beta <- rbind(ANF1_beta_CDR3, ANF3_beta_CDR3, ANF6_beta_CDR3, ANF19_beta_CDR3)
ANF_beta$ID <- "ANF"
ANF_beta$`CDR3 AA sequence` <- as.character(ANF_beta$`CDR3 AA sequence`)
ANF_beta$Month <- as.numeric(ANF_beta$Month)
names(ANF_beta)[names(ANF_beta) == "CDR3 AA sequence"] <- "CDR3s"
names(ANF_beta)[names(ANF_beta) == "Number found in sample"] <- "Count"
dat=ANF_beta
...
scale_alpha_manual(values=c(0, 1)) +
          ...
          labs(title = 'Shared Clonotypes: Patient F (beta chain)', x = 'Month', y = 'Cumulative % of Sample')+
...
ggsave("F_beta_betical.pdf", width = 40, height = 47, units = c('cm'))
