...
HBF1_beta_CDR3 <- HBF1_beta_dcr_cdr3_freq
HBF1_beta_CDR3$Month <- "1"
HBF1_beta_CDR3$Chain <- "beta"

HBF2_beta_CDR3 <- HBF2_beta_dcr_cdr3_freq
HBF2_beta_CDR3$Month <- "2"
HBF2_beta_CDR3$Chain <- "beta"

HBF3_beta_CDR3 <- HBF3_beta_dcr_cdr3_freq
HBF3_beta_CDR3$Month <- "3"
HBF3_beta_CDR3$Chain <- "beta"

HBF6_beta_CDR3 <- HBF6_beta_dcr_cdr3_freq
HBF6_beta_CDR3$Month <- "6"
HBF6_beta_CDR3$Chain <- "beta"

HBF12_beta_CDR3 <- HBF12_beta_dcr_cdr3_freq
HBF12_beta_CDR3$Month <- "12"
HBF12_beta_CDR3$Chain <- "beta"

HBF18_beta_CDR3 <- HBF18_beta_dcr_cdr3_freq
HBF18_beta_CDR3$Month <- "18"
HBF18_beta_CDR3$Chain <- "beta"


#not sure about this
#will try to join data frames
HBF_beta <- rbind(HBF1_beta_CDR3, HBF2_beta_CDR3, HBF3_beta_CDR3, HBF6_beta_CDR3, HBF12_beta_CDR3, HBF18_beta_CDR3)
HBF_beta$ID <- "HBF"
HBF_beta$`CDR3 AA sequence` <- as.character(HBF_beta$`CDR3 AA sequence`)
HBF_beta$Month <- as.numeric(HBF_beta$Month)
names(HBF_beta)[names(HBF_beta) == "CDR3 AA sequence"] <- "CDR3s"
names(HBF_beta)[names(HBF_beta) == "Number found in sample"] <- "Count"
dat=HBF_beta
...
scale_alpha_manual(values=c(0, 1)) +
          ...
          labs(title = 'Shared Clonotypes: Patient H (beta chain)', x = 'Month', y = 'Cumulative % of Sample')+
...
ggsave("H_beta_betical.pdf", width = 40, height = 47, units = c('cm'))
