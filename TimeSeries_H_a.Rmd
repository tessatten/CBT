...
---
#here i am going to look by patient at shared clonotypes, if i can - for HBF.
---
...
HBF1_alpha_CDR3 <- HBF1_alpha_dcr_cdr3_freq
HBF1_alpha_CDR3$Month <- "1"
HBF1_alpha_CDR3$Chain <- "alpha"

HBF2_alpha_CDR3 <- HBF2_alpha_dcr_cdr3_freq
HBF2_alpha_CDR3$Month <- "2"
HBF2_alpha_CDR3$Chain <- "alpha"

HBF3_alpha_CDR3 <- HBF3_alpha_dcr_cdr3_freq
HBF3_alpha_CDR3$Month <- "3"
HBF3_alpha_CDR3$Chain <- "alpha"

HBF6_alpha_CDR3 <- HBF6_alpha_dcr_cdr3_freq
HBF6_alpha_CDR3$Month <- "6"
HBF6_alpha_CDR3$Chain <- "alpha"

HBF12_alpha_CDR3 <- HBF12_alpha_dcr_cdr3_freq
HBF12_alpha_CDR3$Month <- "12"
HBF12_alpha_CDR3$Chain <- "alpha"

HBF18_alpha_CDR3 <- HBF18_alpha_dcr_cdr3_freq
HBF18_alpha_CDR3$Month <- "18"
HBF18_alpha_CDR3$Chain <- "alpha"


#not sure about this
#will try to join data frames
HBF_alpha <- rbind(HBF1_alpha_CDR3, HBF2_alpha_CDR3, HBF3_alpha_CDR3, HBF6_alpha_CDR3, HBF12_alpha_CDR3, HBF18_alpha_CDR3)
HBF_alpha$ID <- "HBF"
HBF_alpha$`CDR3 AA sequence` <- as.character(HBF_alpha$`CDR3 AA sequence`)
HBF_alpha$Month <- as.numeric(HBF_alpha$Month)
names(HBF_alpha)[names(HBF_alpha) == "CDR3 AA sequence"] <- "CDR3s"
names(HBF_alpha)[names(HBF_alpha) == "Number found in sample"] <- "Count"
dat=HBF_alpha
...
temp6 <- datWithFillseq[datWithFillseq$Month == "18",] #sixth time point
...
sampleName1 <- paste("H", unique(temp1.mod$Month), unique(temp1.mod$Chain), sep = '-') #makes the sample name
sampleName2 <- paste("H", unique(temp2.mod$Month), unique(temp2.mod$Chain), sep = '-')
sampleName3 <- paste("H", unique(temp3.mod$Month), unique(temp3.mod$Chain), sep = '-') #makes the sample name
sampleName4 <- paste("H", unique(temp4.mod$Month), unique(temp4.mod$Chain), sep = '-')
sampleName5 <- paste("H", unique(temp5.mod$Month), unique(temp5.mod$Chain), sep = '-')
sampleName6 <- paste("H", unique(temp6.mod$Month), unique(temp6.mod$Chain), sep = '-')
...
scale_alpha_manual(values=c(0, 1)) +
          ...
          scale_x_continuous(breaks = c(1, 3, 5, 7, 9, 11), labels = c(18, 12, 6, 3, 2, 1))+
          ...
          labs(title = 'Shared Clonotypes: Patient H (alpha chain)', x = 'Month', y = 'Cumulative % of Sample')+
...
ggsave("H_alpha_betical.pdf", width = 40, height = 47, units = c('cm'))
