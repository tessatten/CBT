...
RPM1_beta_CDR3 <- RPM1_beta_dcr_cdr3_freq
RPM1_beta_CDR3$Month <- "1"
RPM1_beta_CDR3$Chain <- "beta"

RPM2_beta_CDR3 <- RPM2_beta_dcr_cdr3_freq
RPM2_beta_CDR3$Month <- "2"
RPM2_beta_CDR3$Chain <- "beta"

RPM3_beta_CDR3 <- RPM3_beta_dcr_cdr3_freq
RPM3_beta_CDR3$Month <- "3"
RPM3_beta_CDR3$Chain <- "beta"

RPM12_beta_CDR3 <- RPM12_beta_dcr_cdr3_freq
RPM12_beta_CDR3$Month <- "12"
RPM12_beta_CDR3$Chain <- "beta"

RPM22_beta_CDR3 <- RPM22_beta_dcr_cdr3_freq
RPM22_beta_CDR3$Month <- "22"
RPM22_beta_CDR3$Chain <- "beta"


#not sure about this
#will try to join data frames
RPM_beta <- rbind(RPM1_beta_CDR3, RPM2_beta_CDR3, RPM3_beta_CDR3, RPM12_beta_CDR3, RPM22_beta_CDR3)
RPM_beta$ID <- "RPM"
RPM_beta$`CDR3 AA sequence` <- as.character(RPM_beta$`CDR3 AA sequence`)
RPM_beta$Month <- as.numeric(RPM_beta$Month)
names(RPM_beta)[names(RPM_beta) == "CDR3 AA sequence"] <- "CDR3s"
names(RPM_beta)[names(RPM_beta) == "Number found in sample"] <- "Count"
dat=RPM_beta
...
scale_alpha_manual(values=c(0, 1)) +
          ...
          labs(title = 'Shared Clonotypes: Patient L (beta chain)', x = 'Month', y = 'Cumulative % of Sample')+
...
ggsave("L_beta_betical.pdf", width = 40, height = 47, units = c('cm'))
